...
return [
    ...
    'mobileExist' => 'رقم الجوال غير موجود',
    'custom'               => [
        'attribute-name' => [
    ...
    'attributes' => [
        ...
        'agree'                  => 'الموافقة على شروط الاستخدام وسياسة الخصوصية',
        'license'                  => 'رقم الرخصة',
        'end_at'                  => 'تاريخ الانتهاء',
        'images.*'                  => 'المرفقات',
        'main_judger'                  => 'المحكم الأساسي',
        'sub_judger'                  => 'المحكم الاحتياطي',
        'response_speed'                  => 'سرعة الرد',
        'amount'                  => 'المبلغ',
        'duration'                  => 'المدة',
        'works'                  => 'الأعمال المطلوب تنفيذها ',
        'documents'                  => 'المستندات',
        'execution_method'                  => 'طريقة ووسائل تنفيذ الأعمال',
        'committee' => 'اللجنة',
        'departments' => 'التخصصات القانونية',
        'another_department' => 'التخصص الآخر',
        'other_department' => 'التخصص الآخر',
        'pay_later' => 'الدفع',
        'decision_place' => 'صدور حكم أو قرار من',
        'consulting_department' => 'أقسام الاستشارات',
        'years_of_experience' => 'سنوات الخبرة',
        'iban_cer_photo' => 'شهادة الآيبان',
        'city_name' => 'اسم المدينة',
        'main_department_id' => 'القسم الرئيسي',
        'department_id' => 'القسم',
        'address' => 'العنوان',
        'address' => 'العنوان',
        ...
        "has_tax_certificate" => "يمتلك شهادة ضريبية",
        "tax_certificate_photo" => "الشهادة الضريبية",
        "details" => "التفاصيل",
        "refused_msg"=>"سبب الرفض",
        'status'=>'الحالة',
        'refused'=>'رفض',
        'advisor_file'=>'المؤهل',
        'client_id'=>'العميل',
        'advisor_file_name'=>'اسم المؤهل',
        'consulting_amount'=>'سعر الاستشارة',
    ]
];
