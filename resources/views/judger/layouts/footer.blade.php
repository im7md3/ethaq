...
<footer class="main-footer">
    <div class="container d-flex align-items-center justify-content-center justify-content-sm-between gap-3 flex-column flex-md-row">
...
Tawk_API.customStyle = {
  ...
  //for desktop only
    desktop: {
      ...
      xOffset: 0, // 15px away from right
