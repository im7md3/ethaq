  ...
  <div class="container py-3 text-start d-flex align-items-center justify-content-center justify-content-md-between">
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <div class="dropdown d-none d-lg-block">
        <button class="dropdown-ellipsis dropdown-toggle" type="button" id="dropdownMenuButton1"
        ...
        <ul class="dropdown-menu text-end" aria-labelledby="dropdownMenuButton1">
          ...
          <li><a class="dropdown-item" href="{{ route('vendor.settings') }}">الملف الشخصي</a></li>
      ...
      <!-- <div class="dropdown menu-header">
                <a href="{{ route('vendor.settings') }}"  class="dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                    aria-expanded="false">
        ...
        <div class="offcanvas-body">
          <div class="slide-user">
            ...
            <div class="card-slide box-item">
              <a href="{{ route('vendor.settings') }}" class="btn-icon justify-content-between">
                ملفي الشخصي
                <div class="icon">
...
@endif
@elseif($user->membership == 'individual')
