    ...
    <div class="app-content mt-5">
      <div class="container">
        <div class="invoice-content bg-white rounded-2 p-3 shadow-sm" id="prt-content">
          <div class="status-invoice">{{ __($invoice->status) }}</div>
          <div class="row gap-3 invoice-header">
            <div class="col-lg-5">
              <div class="image-holder text-center text-lg-end ">
                <img src="{{ asset('front-assets/img/global/ethaq-logo.png') }}" alt="invoice-logo" width="250" />
              </div>
            </div>
          ...
          <div class="row gap-3 invoice-bottom-header">
            <div class="col-12 col-md-12 d-flex align-items-center">
              <div
                ...
                <span class="d-block text-fs-13">تاريخ الفاتورة: {{ $invoice->created_at->format('Y-m-d') }}</span>
              </div>
            </div>
            <div class="col-12 col-md-12 d-flex align-items-center">
              <div class="invoice-th-info w-100">
                <h6 class="text-fs-15 mb-2 fw-500">صادرة من: شركة إيثاق لخدمات الأعمال</h6>
                <span class="d-block text-fs-12">الرياض - حي الصحافة</span>
                <span class="d-block">الرقم الضريبي: {{ setting('tax_number') }}</span>
                <span class="d-block">المرسلة إلى: {{ $invoice->fromUser->name }}</span>
              </div>
            </div>
                ...
                <table class="table invoice-table table-n-border table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td width="80%" class="text-center">{{ $invoice->amount - $invoice->admin_ratio }}</td>
                    </tr>
                    @endif
                  </tbody>
                </table>
            ...
            @if($invoice->order_type=='App\Models\Consulting' and $user_type=='client')
            <div class="">
              <p>شروط الفواتير</p>
