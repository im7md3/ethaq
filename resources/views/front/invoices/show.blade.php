                        ...
                        <div class="row gap-3 invoice-bottom-header">
                            <div class="col-12 col-md-12 d-flex align-items-center">
                                <div
                                    ...
                                    <span class="d-block text-fs-15">فاتورة ضريبية</span>
                                    <span class="d-block text-fs-13">تاريخ الفاتورة:{{ $invoice->created_at->format('Y-m-d') }}</span>
                                    @if($user->type=='vendor')
                                    <span class="d-block text-fs-13">الرقم الضريبي:{{ $user->tax_number }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="col-12 col-md-12 d-flex align-items-center">
                                <div class="invoice-th-info w-100">
                                    ...
                                    <span class="d-block mb-1">العنوان: الرياض - حي الصحافة</span>
                                    <span class="d-block mb-1">الرقم الضريبي: {{ setting('tax_number') }}</span>
                            ...
                            @if ($invoice->order_type == 'App\Models\Consulting' and $user->type == 'client')
                                <div class="">
                                    <p>شروط الفواتير</p>
