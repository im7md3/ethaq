            ...
            <div class="row row-gap-24">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="membership" class="form-control" v-model="membership">
                        ...
                        <option value="individual" {{ $vendor->membership=='individual'?'selected':'' }}>فردي</option>
                        <option value="company" {{ $vendor->membership=='company'?'selected':'' }}>شركة</option>
                    </select>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="gender" class="form-control">
                        ...
                        <option value="male" {{ $vendor->gender=='male'?'selected':'' }}>ذكر</option>
                        <option value="female" {{ $vendor->gender=='female'?'selected':'' }}>انثى</option>
                    </select>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <label for="" class="small-label">تاريخ الميلاد </label>
                    <input type="date" name="birthdate" class="form-control"
                        value="{{ old('birthdate',$vendor->birthdate) }}">
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <input type="number" name="phone" value="{{ $vendor->phone }}" class="form-control rmv-arw-inp">
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <input type="date" name="id_end" class="form-control rmv-arw-inp"
                        value="{{ old('id_end',$vendor->id_end) }}">
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="country_id" class="form-control">
                        ...
                        <option value="{{ $country->id }}" {{ $country->id==$vendor->country_id?'selected':'' }}>{{
                            $country->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3" v-if="type=='vendor' || type=='judger'">
                    ...
                    <input type="number" name="years_of_experience" max="99" class="form-control"
                        onkeypress="if(this.value.length==2) return false;" value="{{ $vendor->years_of_experience }}">
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3" v-if="type=='vendor' || type=='judger'">
                    <label for="" class="small-label"> التخصص </label>
                    <select name="specialty_id" class="form-control">
                        <option value="">أختر التخصص </option>
                        @foreach (App\Models\Specialty::where('type',$vendor->type)->get() as $specialty)
                        <option value="{{ $specialty->id }}" {{ $specialty->id==$vendor->specialty_id?'selected':''
                            }}>{{
                ...
                <div class="col-sm-6 col-md-4 col-lg-3" v-if="type=='vendor' || type=='judger'">
                    ...
                    <select name="qualification_id" class="form-control">
                        ...
                        @foreach (App\Models\Qualification::where('type',$vendor->type)->get() as $qualification)
                        <option value="{{ $qualification->id }}" {{ $qualification->
                            id==$vendor->qualification_id?'selected':'' }}>{{ $qualification->name }}</option>
                        @endforeach
                    </select>
                </div>
                {{-- <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="city_id" class="form-control">
                        ...
                        <option value="{{ $city->id }}" {{ $city->id==$vendor->city_id?'selected':'' }}>{{ $city->name
                            }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="is_block" class="form-control">
                        ...
                        <option value="0" {{ $vendor->is_block == 0 ?'selected':'' }}>فعال</option>
                        <option value="1" {{ $vendor->is_block == 1 ?'selected':'' }}>غير فعال</option>
                    </select>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="enable_sms" class="form-control">
                        ...
                        <option value="1" {{ $vendor->enable_sms == 1 ?'selected':'' }}>نعم</option>
                        <option value="0" {{ $vendor->enable_sms == 0 ?'selected':'' }}>لا</option>
                    </select>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="is_advisor" class="form-control">
                        ...
                        <option value="1" {{ $vendor->is_advisor == 1 ?'selected':'' }}>نعم</option>
                        <option value="0" {{ $vendor->is_advisor == 0 ?'selected':'' }}>لا</option>
                    </select>
                </div>
...
<script>
    ...
    mounted(){
        ...
        this.membership='{{ $vendor->membership }}'
    }
