...
@section('content')
    <section class=" show-user">
        ...
        <div class="content_view">
            ...
            <ul class="nav nav-tabs mt-4 mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" data-bs-target="#nav-licenses" type="button">
                        <div class="badge-count">{{ $user->advisor_file_count }}</div>
                        المؤهلات
            ...
            @include('admin.advisor.tabs.commercials')
            @include('admin.advisor.tabs.advisorFiles')
            @include('admin.advisor.tabs.invoices')
            @include('admin.advisor.tabs.consulting')
            @include('admin.advisor.tabs.balance')
            @include('admin.advisor.tabs.notes.notes')
