    ...
    <div class="content_view">
        <form action="{{ route('admin.clients.update',$client->id) }}" method="POST" enctype="multipart/form-data">
            <div class="row row-gap-24">
                @csrf
                @method('PUT')
                <input type="hidden" name="type" value="client" id="">
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="membership" class="form-control" v-model="membership">
                        ...
                        <option value="individual" {{ $client->membership=='individual'?'selected':'' }}>فردي</option>
                        <option value="company" {{ $client->membership=='company'?'selected':'' }}>شركة</option>
                    </select>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="gender" class="form-control">
                        ...
                        <option value="female" {{ $client->gender=='female'?'selected':'' }}>انثى</option>
                    </select>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <input type="number" name="phone" value="{{ $client->phone }}" class="form-control rmv-arw-inp">
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <input type="date" name="id_end" class="form-control rmv-arw-inp"
                        value="{{ old('id_end',$client->id_end) }}">
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="country_id" class="form-control">
                        ...
                        <option value="{{ $country->id }}" {{ $country->id==$client->country_id?'selected':'' }}>{{
                            $country->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3" v-if="type=='vendor' || type=='judger'">
                    ...
                    <input type="number" name="years_of_experience" max="99" class="form-control"
                        onkeypress="if(this.value.length==2) return false;" value="{{ $client->years_of_experience }}">
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3" v-if="type=='vendor' || type=='judger'">
                    <label for="" class="small-label"> التخصص </label>
                    <select name="specialty_id" class="form-control">
                        <option value="">أختر التخصص </option>
                        @foreach (App\Models\Specialty::where('type',$client->type)->get() as $specialty)
                        <option value="{{ $specialty->id }}" {{ $specialty->id==$client->specialty_id?'selected':'' }}>{{
                ...
                <div class="col-sm-6 col-md-4 col-lg-3" v-if="type=='vendor' || type=='judger'">
                    ...
                    <select name="qualification_id" class="form-control">
                        ...
                        @foreach (App\Models\Qualification::where('type',$client->type)->get() as $qualification)
                        <option value="{{ $qualification->id }}" {{ $qualification->
                            id==$client->qualification_id?'selected':'' }}>{{ $qualification->name }}</option>
                        @endforeach
                    </select>
                </div>
                {{-- <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="city_id" class="form-control">
                        ...
                        <option value="{{ $city->id }}" {{ $city->id==$client->city_id?'selected':'' }}>{{ $city->name }}
                        </option>
                        @endforeach
                    </select>
                </div> --}}
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="is_block" class="form-control">
                        ...
                        <option value="1" {{ $client->is_block == 1 ?'selected':'' }}>فعال</option>
                        <option value="0" {{ $client->is_block == 0 ?'selected':'' }}>غير فعال</option>
                    </select>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="enable_sms" class="form-control">
                        ...
                        <option value="1" {{ $client->enable_sms == 1 ?'selected':'' }}>نعم</option>
                        <option value="0" {{ $client->enable_sms == 0 ?'selected':'' }}>لا</option>
                    </select>
                </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3" v-if="membership=='company' && type=='client'">
                    ...
                    <input type="number" name="company_number" class="form-control"
                        value="{{ old('company_number',$client->company_number) }}">
                </div> --}}
                <div class="col-sm-12">
                    <div class="mb-1"> النبذة الشخصية <span class="text-danger">*</span></div> <textarea
                        placeholder="النبذة الشخصية" name="bio" maxlength="1000" class="form-control">{{ $client->bio }}</textarea>
                </div>
