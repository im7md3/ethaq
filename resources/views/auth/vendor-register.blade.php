                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-10 col-md-8 col-lg-6">
                                <div class="box-register">
                                    ...
                                    <form action="">
                                        {{-- <div class="mb-4" v-if="user=='client'">
                                            <label for="">
                                                الاسم المستعار
                                            </label>
                                            <input  type="text" required class=" form-control" name="username"
                                                value="{{ old('username') }}" v-model='username'>
                                        </div>
    ...
    computed: {
            ...
            methods: {
                ...
                checkUser(evt) {
                    ...
                    if (inpUser.parentElement.querySelector(
                        `.card-type-user input[value="${this.membership}"]`)) {
                        inpUser.parentElement.querySelector(`.card-type-user input[value="${this.membership}"]`)
